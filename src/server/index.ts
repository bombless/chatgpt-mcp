...
// Local-only admin/test UI. It is intentionally bound to the same server socket but only
// serves the UI when the request arrives from loopback. SSH port forwarding can expose it locally.

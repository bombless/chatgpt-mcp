...
function buildMcpServer() {
  ...
  codingTool('tail_file', 'Read the last N lines of a UTF-8 file.', { agentId: agentIdSchema, path: z.string().min(1), lines: z.number().int().min(1).max(10000).default(100) }, z.object({ result: z.string() }));
